# Agilex 3 Hostless JTAG Example Design

Demonstrate inference over JTAG and target FPGA AI Suite IP on the Agilex 3C Development Kit

## Description

This example design demonstrates how to run the AI Suite on an Altera Agilex 3
C-Series Development Kit in a hostless configuration. The example
design supports sending inference requests via JTAG in order to demonstrate how
commands can be sent to the AI Suite IP.

The example design uses the `AGX3_Small_NoSoftmax.arch` architecture.
...
`$EXAMPLES_PATH/agilex3/jtag/output_files/top.sof`.
> [!NOTE]
...
> [[HL-JTAG] Performing Inference on the Agilex 3 FPGA C-Series Development Kit](https://www.intel.com/content/www/us/en/docs/programmable/848957/2025-3/performing-inference-on-the.html)
> for details.
...
# Reprogram the FPGA
quartus_pgm -c 1 -m jtag -o "p;$EXAMPLES_PATH/agilex3/jtag/output_files/top.sof"
...
dla_compiler \
    --march $COREDLA_ROOT/example_architectures/AGX3_Small_NoSoftmax.arch \
