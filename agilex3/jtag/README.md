...
> Agilex™ 3 FPGA C-Series Development Kit section in the
...
# Build the runtime
./build_runtime.sh -target_agx3_dev_jtag_system_console
...
# Build the runtime
./build_runtime.sh -disable_jit -target_agx3_dev_jtag_system_console
