...
module top #() (
  //Reset&Clock
  input  wire         i_fpga_core_resetn       ,
  input  wire         i_pll_ref_clk            ,

  // LPDDR4 interface COMP1
  input  wire         i_lpddr4_comp1_refclk_p  ,
  input  wire         i_lpddr4_comp1_rzq       ,
  output wire         o_lpddr4_comp1_reset_n   ,
  output wire [0:0]   o_lpddr4_comp1_ck_p      ,
  output wire [0:0]   o_lpddr4_comp1_ck_n      ,
  output wire [5:0]   o_lpddr4_comp1_ca        ,
  output wire [0:0]   o_lpddr4_comp1_cs        ,
  output wire [0:0]   o_lpddr4_comp1_cke       ,
  inout  wire [3:0]   io_lpddr4_comp1_dmi      ,
  inout  wire [3:0]   io_lpddr4_comp1_dqs_p    ,
  inout  wire [3:0]   io_lpddr4_comp1_dqs_n    ,
  inout  wire [31:0]  io_lpddr4_comp1_dq
  //  DBI is disabled
);
...
shell pd (
  .emif_0_mem_0_mem_cs                         (o_lpddr4_comp1_cs),
  .emif_0_mem_0_mem_ca                         (o_lpddr4_comp1_ca),
  .emif_0_mem_0_mem_cke                        (o_lpddr4_comp1_cke),
  .emif_0_mem_0_mem_dq                         (io_lpddr4_comp1_dq),
  .emif_0_mem_0_mem_dqs_t                      (io_lpddr4_comp1_dqs_p),
  .emif_0_mem_0_mem_dqs_c                      (io_lpddr4_comp1_dqs_n),
  .emif_0_mem_0_mem_dmi                        (io_lpddr4_comp1_dmi),
  .emif_0_mem_0_ck_mem_ck_t                    (o_lpddr4_comp1_ck_p),
  .emif_0_mem_0_ck_mem_ck_c                    (o_lpddr4_comp1_ck_n),
  .emif_0_mem_0_reset_n_mem_reset_n            (o_lpddr4_comp1_reset_n),
  .emif_0_oct_0_oct_rzqin                      (i_lpddr4_comp1_rzq),
  ...
  .dla_pll_0_refclk_clk                  (i_pll_ref_clk),
  .jtag_pll_0_refclk_clk                 (i_pll_ref_clk),
  .emif_0_ref_clk_0_clk                  (i_lpddr4_comp1_refclk_p),
