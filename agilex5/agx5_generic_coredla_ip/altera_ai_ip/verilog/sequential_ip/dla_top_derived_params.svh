...
localparam device_family_t DEVICE_ENUM = PE_ARRAY_ARCH.DEVICE_FAMILY;
...
localparam dla_filter_bias_scale_scratchpad_pkg::filter_bias_scale_scratchpad_arch_t SCRATCHPAD_ARCH = '{
  ...
  MANTISSA_DELAY: 1,
  FILTER_SYSTOLIC_OPERANDS : ((PE_ARRAY_ARCH.DOT_MODE == DOT_MODE_PACK1X1_MULT9_CHAIN_ADD) ? 4 : PE_ARRAY_ARCH.DOT_SIZE),
...
localparam dla_sequencer_pkg::sequencer_arch_t SEQUENCER_ARCH = '{
  ...
  SCRATCHPAD_READ_TO_WRITE_DELAY : max(4,
    max(
      ((PE_ARRAY_ARCH.NUM_FILTERS == 1) ?
        (PE_ARRAY_ARCH.DOT_MODE == DOT_MODE_PACK1X1_MULT9_CHAIN_ADD ?
          max(
            max(dla_systolic_ram_pkg::get_read_to_write_delay(
                  dla_filter_bias_scale_scratchpad_pkg::get_filter_systolic_mantissa_full_params(SCRATCHPAD_ARCH)),
                dla_systolic_ram_pkg::get_read_to_write_delay(
                  dla_filter_bias_scale_scratchpad_pkg::get_filter_systolic_mantissa_partial_params(SCRATCHPAD_ARCH))
               ),
            dla_systolic_ram_pkg::get_read_to_write_delay(
              dla_filter_bias_scale_scratchpad_pkg::get_filter_exponent_params(SCRATCHPAD_ARCH)
            )
          )
          : dla_systolic_ram_pkg::get_read_to_write_delay(
              dla_filter_bias_scale_scratchpad_pkg::get_filter_params(SCRATCHPAD_ARCH)
            )
        )
        : max (
          dla_systolic_ram_pkg::get_read_to_write_delay(
            dla_filter_bias_scale_scratchpad_pkg::get_multi_filter_mantissa_params(SCRATCHPAD_ARCH)
          ),
          dla_systolic_ram_pkg::get_read_to_write_delay(
            dla_filter_bias_scale_scratchpad_pkg::get_filter_exponent_params(SCRATCHPAD_ARCH)
          )
      ...
      dla_systolic_ram_pkg::get_read_to_write_delay(
        dla_filter_bias_scale_scratchpad_pkg::get_bias_scale_params(SCRATCHPAD_ARCH)
      )
    )
  ),
  SCRATCHPAD_WRITE_TO_READ_DELAY : max(4,
    max(
      ((PE_ARRAY_ARCH.NUM_FILTERS == 1) ?
        (PE_ARRAY_ARCH.DOT_MODE == DOT_MODE_PACK1X1_MULT9_CHAIN_ADD ?
          max(
            max(dla_systolic_ram_pkg::get_write_to_read_delay(
                  dla_filter_bias_scale_scratchpad_pkg::get_filter_systolic_mantissa_full_params(SCRATCHPAD_ARCH)),
                dla_systolic_ram_pkg::get_write_to_read_delay(
                  dla_filter_bias_scale_scratchpad_pkg::get_filter_systolic_mantissa_partial_params(SCRATCHPAD_ARCH))
               ),
            dla_systolic_ram_pkg::get_write_to_read_delay(
              dla_filter_bias_scale_scratchpad_pkg::get_filter_exponent_params(SCRATCHPAD_ARCH)
...
localparam dla_input_feeder_pkg::input_feeder_arch_t INPUT_FEEDER_ARCH = '{
  ...
  MANTISSA_DELAY: 0, // set to 1 once the stream buffer RAM can be turned into a systolic RAM
  FEATURE_SYSTOLIC_OPERANDS : PE_ARRAY_ARCH.DOT_SIZE, // ((PE_ARRAY_ARCH.DOT_MODE == DOT_MODE_PACK1X1_MULT9_CHAIN_ADD) ? 4 : PE_ARRAY_ARCH.DOT_SIZE),
  DEVICE: DEVICE_ENUM
};
...
localparam int LT_ELEMENT_WIDTH = (LAYOUT_TRANSFORM_CONV_MODE == U8_TO_F16)  ? 8  :
                                  (LAYOUT_TRANSFORM_CONV_MODE == U9_TO_F16)  ? 9  :
                                  (LAYOUT_TRANSFORM_CONV_MODE == U10_TO_F16) ? 10 :
                                  (LAYOUT_TRANSFORM_CONV_MODE == U11_TO_F16) ? 11 :
                                  (LAYOUT_TRANSFORM_CONV_MODE == U12_TO_F16) ? 12 :
                                  (LAYOUT_TRANSFORM_CONV_MODE == U13_TO_F16) ? 13 :
                                  (LAYOUT_TRANSFORM_CONV_MODE == U14_TO_F16) ? 14 :
                                  (LAYOUT_TRANSFORM_CONV_MODE == U15_TO_F16) ? 15 :
                                  16;
localparam dla_lt_pkg::lt_arch_t LT_ARCH = '{
  ...
  NUM_CHANNELS: LAYOUT_TRANSFORM_NUM_CHANNELS,
  DEVICE: DEVICE_ENUM
};
