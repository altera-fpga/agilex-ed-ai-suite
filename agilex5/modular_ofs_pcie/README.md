# Agilex 5 PCIe-Attached Example Design with OFS

Demonstrates ML inference using the Agilex 5 FPGA E-Series 065B Modular Development Kit

## Description

This example design demonstrates how to run the AI Suite on an Agilex 5 Intel
Modular Development Kit connected to a host via PCIe.
...
* [OFS 2025.1-1 Modular Development Kit FIM](https://github.com/OFS/ofs-agx5-pcie-attach/releases/download/ofs-2025.1-1/eseries-mdk-images_ofs-2025-1-1.tar.gz)
...
export OPAE_PLATFORM_ROOT="$HOME/OFS/eseries-mdk-images_ofs-2025-1-1/pr_build_template"

# Prepare and compile the Quartus project.
cd $EXAMPLES_PATH/agilex5/modular_ofs_pcie
./setup_project.sh
./build_project.sh
```
...
`$EXAMPLES_PATH/agilex5/modular_ofs_pcie/ofs/` directory.
...
# Reprogram the FPGA
fpgaconf -V $EXAMPLES_PATH/agilex5/modular_ofs_pcie/ofs/dla_afu.gbs
...
# Build the runtime
./build_runtime.sh -disable_jit -target_agx5_e_mdk
