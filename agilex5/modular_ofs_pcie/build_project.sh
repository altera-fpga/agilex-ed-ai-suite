...
quartus_sh -t $REL_ROOT_DIR/../dla_parse_report.tcl \
    ...
    -ip-clock "afu_top|pg_afu.port_gasket|user_clock|qph_user_clk|pll.qph_user_clk_iopll|iopll_0_outclk1" \
    -platform-clock "afu_top|pg_afu.port_gasket|user_clock|qph_user_clk|pll.qph_user_clk_iopll|iopll_0_outclk1" \
