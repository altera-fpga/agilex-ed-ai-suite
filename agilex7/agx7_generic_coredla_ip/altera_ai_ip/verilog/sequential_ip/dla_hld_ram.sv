...
module dla_hld_ram import dla_common_pkg::*; #(
    ...
    parameter      RAM_BLOCK_TYPE,                  //legal values are: "M20K", "MLAB", "HLD_RAM_TO_CHOOSE"
    ...
    localparam bit RAM_BLOCK_TYPE_IS_HLD_RAM_TO_CHOOSE = RAM_BLOCK_TYPE == "HLD_RAM_TO_CHOOSE";
    `DLA_ACL_PARAMETER_ASSERT_MESSAGE(RAM_BLOCK_TYPE_IS_M20K || RAM_BLOCK_TYPE_IS_MLAB || RAM_BLOCK_TYPE_IS_HLD_RAM_TO_CHOOSE, $sformatf("Illegal RAM_BLOCK_TYPE: %s.", RAM_BLOCK_TYPE))
