...
set_module_property NAME intel_ai_ip
...
set_fileset_property synthesis_files TOP_LEVEL intel_ai_ip
proc render_top_level {} {
  # get template
  set template_path "./verilog/intel_ai_ip.sv.terp"
...
add_fileset_file intel_ai_ip/intel_ai_ip.sv SYSTEM_VERILOG TEXT [render_top_level]
...
set_module_property DESCRIPTION "The Intel FPGA AI Suite is an AI Engine."
set_module_property DISPLAY_NAME "Intel FPGA AI Suite"
