...
if {[string match $revision_name "top"] && ($fast_compile) && (($device_family == "Stratix 10") ||($device_family == "Agilex") || ( $device_family == "Agilex 7" ) || ($device_family == "Agilex 5"))} {
...
if {!$fast_compile} {
  ...
  # Re-run STA
  post_message "Launching STA with report script dla_failing_clocks.tcl"
